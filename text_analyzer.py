...
def total_letters(text):
    ...
    """
    cantidadtotal = count_vowels(text)+count_consonants(text)
...
def analyze_text(text):
    ...
    percentagevowels = vowel_percentage(text)

    return f"V:{vowels} C:{consonants} T:{total} P:{percentagevowels}%"
